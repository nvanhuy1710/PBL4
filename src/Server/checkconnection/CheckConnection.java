	...
	public void run() {
		for (String key : clients.keySet()) {
			try {
				...
				clients.remove(this.client.getInetAddress().getHostName() + "_"
				...
				for (int i = 0; i < rowCount; i++) {
					...
					if (hostName.equals(this.client.getInetAddress().getHostName())
							&& hostAddress.equals(this.client.getInetAddress().getHostAddress())) {
